...
# Date: 2018-02-05 09:39:26
# Generator: MySQL-Front 5.3  (Build 4.234)

/*!40101 SET NAMES utf8 */;

#
# Structure for table "co_direct"
#
...
#
# Data for table "co_direct"
#

/*!40000 ALTER TABLE `co_direct` DISABLE KEYS */;
INSERT INTO `co_direct` VALUES (1,'数据库'),(2,'防火墙'),(3,'文档'),(5,'管理'),(6,'编程'),(7,'基础入门');
/*!40000 ALTER TABLE `co_direct` ENABLE KEYS */;

#
# Structure for table "co_type"
#
...
#
# Data for table "co_type"
#

/*!40000 ALTER TABLE `co_type` DISABLE KEYS */;
INSERT INTO `co_type` VALUES (1,'入门'),(2,'进阶'),(3,'高级'),(5,'新手');
...
INSERT INTO `exam` VALUES (4,'2013201311','这是一门计算机网络考试1','/pic/data.jpg','计算机网络1','2018-01-24','23:01','08:01'),(13,'2013201311','20182',NULL,'计算机网络','2018-02-02','23:00','00:00');
...
INSERT INTO `homepage` VALUES (1,2,2,'/pic/20180202085045569DSC_00433115.jpg'),(2,2,1,'[\"2013201311\",\"2013201311\"]'),(3,0,0,'[\"1\"]');
...
INSERT INTO `inform` VALUES (1,2013201308,'水声工程团队入选教育部首批“全国高校黄大年式教师团队”','经过高校自主申报、省级教育行政部门遴选推荐、专家评审等环节，水声工程团队凭借其在师德师风、教育教学、科研创新、社会服务、团队建设等方面取得的突出成果和工作实绩入选。党的十八大以来，该团队培养硕士研究生642人、博士研究生136人；编写教材6本、教学案例2项。团队科研项目获省部级以上奖项23项，教学成果获省部级以上奖项6项，团队及成员获省部级以上表彰23项。团队重要科研立项项目3.1亿元，其中，1000万以上项目4项。','[\"/pic/1.jpg\",\"/pic/1.jpg\"]','2017-12-27 08:00:00',NULL,1,1),(2,2013201308,'助“深海勇士”号“大海捞针”','由教育部科学技术委员会组织评选的2017年度“中国高等学校十大科技进展”日前在京揭晓，我校水声学院孙大军教授主持完成的“深海高精度水声综合定位技术”跻身十强，是海洋工程领域唯一入选项目，标志着我国在深海高精度水声定位研究达到国际领先水平。','[\"/pic/1.jpg\",\"/pic/1.jpg\"]','2017-12-25 08:00:00','/pic/1.jpg',0,1),(10,2013201310,'新建公告','功能','[\"/pic/20180201143934752\"]','2018-02-01 14:39:34',NULL,0,1);
